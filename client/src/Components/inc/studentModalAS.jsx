...
//fetch student details & marks data
...
const getMarksData = async() => {
    const response = await axios.post("http://localhost:3001/studentmarks/studentmarksas", {studentid: activeId})
    setStuMarks(response.data)
}
//Calling the student detail and marks function on page render
useEffect(()=>{
...
const submitMarks = async(e) => {
    await axios.post("http://localhost:3001/studentmarks/academicsupervisor", {
        name,
        adherence,
        presentation,
        evidence,
    ...
    getMarksData();
      ...
      const submitApproval = async () => {
        ...
        await axios.put("http://localhost:3001/academicsupervisor/approve", {studentid: activeId, approvalStatus: true})

      }

      const submitAssesmentDate = async (id) => {
       
        await axios.put("http://localhost:3001/academicsupervisor/setdate", {studentid: activeId, assessmentDate})
        fetchStudentData();
      }
