...
//code to input supervisor comments data to the database
 const updateSupervisorComments = async () => {
    await axios.put("http://localhost:3001/logbook/inputcomments", {week: dropValue, studentid: activeId, supervisorComments})
 }

//code to approve week data
const submitApproval = async () => {
    await axios.put("http://localhost:3001/logbook/approveweek", {week: dropValue, studentid: activeId, approvalStatus: true})
}
...
//code to input marks data to the database
 ...
 const clearState = () =>{
    ...
    //code to fetch the uploadedreport data
