    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            if(newPassword === confirmPassword){
                    await axios.post('http://localhost:3001/fieldsupervisor/register',{
                        name: username,
                        email: newEmail,
                        phone: phone,
        ...
        <>
            ...
            <div className='loginArea mx-auto'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3" style={{marginTop:20}}>
                        <label for="exampleInputPassword3" className="form-label">Company</label>
                        <input type="text" className="form-control" onChange={(e)=>{
...
export default FieldSupervisorRegister;