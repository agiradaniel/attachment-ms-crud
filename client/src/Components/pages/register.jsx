                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input
                     ...
                     <div className="mb-3" style={{marginTop:20}}>
                        <label for="exampleInputPassword4" className="form-label">ADM NO</label>
                    ...
                    <div className="mb-3" style={{marginTop:20}}>
                        <label for="exampleInputPassword3" className="form-label">Attaching Company</label>
                        <input type="text" className="form-control" onChange={(e)=>{
                    ...
                    <div className="mb-3" style={{marginTop:20}}>
                        <label for="exampleInputPassword3" className="form-label">Location(Attaching company)</label>
                        <input type="text" className="form-control" onChange={(e)=>{
